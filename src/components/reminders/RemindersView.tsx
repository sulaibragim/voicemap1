...
function buildFlatList(recordings: Recording[], notes: Note[]): ReminderItem[] {
...
type Section = 'overdue' | 'today' | 'upcoming' | 'nodatetime';

function classifyReminder(item: ReminderItem, todayISO: string, currentTime: string): Section {
...
function sortByDateTime(a: ReminderItem, b: ReminderItem): number {
  return (a.date + a.time).localeCompare(b.date + b.time);
}

const SECTION_CONFIG: Record<Section, { label: string; colorClass: string; bgClass: string; borderClass: string }> = {
