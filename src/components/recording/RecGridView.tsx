      ...
      {recordings.length === 0 ? (
        ...
        return (
          <motion.div
            ...
            className="rounded-2xl border overflow-hidden cursor-pointer group transition-all hover:border-primary/30"
            style={{
          ...
          >
            ...
            <div className="relative aspect-[16/9] overflow-hidden">
              ...
              {incomplete && (
                <span className="absolute top-2 right-2 text-[9px] font-bold px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(0,0,0,0.6)', color: '#4FC3F7' }}>
                  задачи
                </span>
              )}
            </div>
